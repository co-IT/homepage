 ...
 */
export const ContentOverlapPortrait = component$((props: ContentOverlapPortraitProps) => {
  return (
    <article class='grid auto-rows-min md:grid-cols-8 md:grid-rows-1'>
      ...
      <div class='z-10 row-start-1 md:col-span-3 md:col-start-5 md:row-span-full'>
        <img class='shadow-xl' width='480' height='586' src={props.image.source} alt={props.image.alternateText} />
      </div>
