      ...
      <div class='flex w-full flex-row justify-center'>
        <div class='relative'>
          <a href={props.googleMapsLink} target='_blank'>
            <img src={props.map} alt='map' class='h-64 object-cover' />
          </a>
          <div class='absolute -left-[16%] -top-[12%] flex flex-col gap-y-7 bg-white px-10 py-9 shadow-xl'>
            ...
            <div class='flex flex-col gap-y-1'>
              <div class='text-lg font-normal leading-5 text-secondary-900'>{props.address1}</div>
              <div class='text-lg font-normal leading-5 text-secondary-900'>{props.address2}</div>
            </div>
