...
export const ArticleTriad = component$(() => {
  return (
    <article class="grid auto-rows-min md:grid-cols-8 md:grid-rows-1">
      <div class="z-20 row-start-3 -translate-y-28 mx-3 pt-10 pb-10 pr-5 pl-5 grid-flow-row md:-translate-y-0 md:row-span-full md:col-start-2 md:col-span-4 md:p-14 shadow-md  self-center bg-white">
