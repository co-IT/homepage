...
<HeadingArticle text='Hinweis zu SVG-Icons' />

Ein Teil der auf dieser Website verwendeten SVG-Icons stammt aus Lucide und wird unter der ISC-Lizenz verwendet. Die vollständige Lizenz ist hier verlinkt: [Lucide LICENSE](https://github.com/lucide-icons/lucide/blob/main/LICENSE).
