...
export const branchenOverview: PageContent = {
  ...
  contentHeading: 'IT, Software und Cyber-Sicherheit für unterschiedliche Anforderungen',
  contentText:
  ...
  articles: [
    ...
    },
    {
      ...
      callToAction: {
        ...
        ariaLabel: 'Mehr über IT-Sicherheit und Digitalisierung für Behörden erfahren'
      }
    }
  ]
};
