    ...
    <>
        ...
        <div class='grid grid-flow-row justify-center gap-16 sm:grid-flow-col'>
          ...
          <section class='flex max-w-md flex-col gap-4 px-4'>
            ...
            <p class='whitespace-pre-line text-left text-base font-normal leading-7 tracking-normal text-black opacity-80 '>
              ...
              Werkzeugkasten, der untere anderem die eigene Passwortsicherheit prüfen kann. Besonders interessant sind
      ...
      <Section id='sie_wollen_ihre_anwender_schulen' backgroundColor='gray'>
        <div class='flex flex-col gap-y-8 px-4 sm:items-center'>
          ...
          <p class='max-w-xl'>
            Für Kunden, die persönliche Schulung zu schätzen wissen, flankieren wir unser Portal mit maßgeschneiderten
            Trainings vor Ort und remote. Vereinbaren Sie gerne direkt einen Telefontermin.
          </p>
      ...
      <Section id='partner_it_sicherheit'>
        <div class='flex flex-col gap-y-8 px-4 sm:items-center'>
          ...
          <p class='max-w-xl'>
            ...
            uns Anrufe und Mails, ob wir eine Bestandsaufnahme der IT-Sicherheit durchführen und - falls notwendig -
            ...
            können Sie eine kostenfreie, 30-minütige Erstberatung buchen.
          </p>
