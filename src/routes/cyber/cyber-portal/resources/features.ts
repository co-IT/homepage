...
export const starterFeatures: ProductFeature[] = [
  {
    text: 'E-Mail-Support',
    detail:'Unsere Reaktionszeiten sind in deutscher Sprache von Montag-Freitag zw. 9-16 Uhr und innerhalb von 48 Stunden.'
  },{
...
export const profiFeatures: ProductFeature[] = [
  {
    ...
    text: '"Attack Pack": Behörden',
    detail: 'Arbeitsrecht, Elternzeit, Unfallversicherung: Diese Inhalte sind für jeden interessant und haben eine hohe Klickquote.'
  },{
    ...
    text: 'Abteilungsname',
    detail: 'In den Phishing Simulationen wird die Abteilung des Empfängers referenziert, z.B. indem eine "Datenschutzbefragung" im "Einkauf" simuliert wird.'
  },{
